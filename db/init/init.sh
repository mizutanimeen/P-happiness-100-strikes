...
# Date Records
$CMD_MYSQL -e "create table ${MYSQL_DATE_RECORD_TABLE} (
    ${MYSQL_DATE_RECORD_ID} int(16) AUTO_INCREMENT,
    ${MYSQL_USERS_ID} varchar(32) NOT NULL,
    ${MYSQL_DATE_RECORD_DATE} DATETIME NOT NULL,
    ${MYSQL_DATE_RECORD_HAPPINESS} int(16) NOT NULL,
    ${MYSQL_CREATEDAT} DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ${MYSQL_UPDATEDAT} DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (${MYSQL_DATE_RECORD_ID}),
    UNIQUE (${MYSQL_USERS_ID}, ${MYSQL_DATE_RECORD_DATE}),
...
$CMD_MYSQL -e "create table ${MYSQL_RPM_RECORD_TABLE} (
    ...
    FOREIGN KEY (${MYSQL_TIME_RECORD_ID}) REFERENCES ${MYSQL_TIME_RECORD_TABLE}(${MYSQL_TIME_RECORD_ID}) ON DELETE CASCADE,
    FOREIGN KEY (${MYSQL_USERS_ID}) REFERENCES ${MYSQL_USERS_TABLE}(${MYSQL_USERS_ID})
);"
