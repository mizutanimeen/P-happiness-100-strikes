...
$CMD_MYSQL -e "create table ${MYSQL_DAY_RECORD_TABLE} (
    ...
    ${MYSQL_USERS_ID} varchar(32) NOT NULL,
    ${MYSQL_DAY_RECORD_DATE} varchar(64) NOT NULL,
...
$CMD_MYSQL -e "create table ${MYSQL_TIME_RECORD_TABLE} (
    ...
    ${MYSQL_DAY_RECORD_ID} int(16) NOT NULL,
    ${MYSQL_TIME_RECORD_START_TIME} varchar(64) NOT NULL,
    ...
    FOREIGN KEY (${MYSQL_DAY_RECORD_ID}) REFERENCES ${MYSQL_DAY_RECORD_TABLE}(${MYSQL_DAY_RECORD_ID})
);"
